...
export default function Analytics() {
  ...
  return (
    <div className="space-y-6">
      ...
      {habits.length > 0 && (
        <section>
          <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Habit Calendars</h4>
          <div className="space-y-6">
            {habits.map(habit => (
              <div key={habit.id} className="p-6 card">
                <div className="flex items-center justify-between mb-4">
                  <h5 className="text-base font-semibold text-gray-900 dark:text-gray-100">{habit.name}</h5>
                </div>
